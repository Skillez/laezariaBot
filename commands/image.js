const { Discord, errorLog } = require('../laezariaBot');
...
module.exports.run = async (bot, message, args) => {
    ...
    if (args[0]) {
        if (args[0].toLowerCase() === 'laezaria') return AttachTheImage('https://i.imgur.com/wplVBfr.png');
