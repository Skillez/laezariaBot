...
bot.on("message", async message => {
    ...
    if (message.channel.id != config.ApplicationChannelID) return; // return if not application channel
    ...
    function WarningMessage(applicationMessage, Nick, WarningLevel, Reason, Evid1, Evid2, Evid3, Evid4) {
        ...
        let embed_warning_application = new Discord.MessageEmbed()
            ...
            .setTimestamp()
        sendEmbedLog(embed_warning_application, config.BotLogChannelID, 'Laezaria Bot - Logs');
    }
});